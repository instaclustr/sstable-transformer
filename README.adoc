...
----
$ java -jar target/sstable-transformer-core-2.0.0-bundled.jar help
...
----
java -jar target/sstable-transformer-core-2.0.0-bundled.jar transform \
  --keyspace=spark_test \
  --table=test3 \
...
----
$ java -jar target/sstable-transformer-core-2.0.0-bundled.jar partitions \
    --dc=dc1 \
    --keyspace=spark_test \
...
----
 $ java -jar target/sstable-transformer-core-2.0.0-bundled.jar transform help
...
----
 java -jar target/sstable-transformer-core-2.0.0-bundled.jar help partitions
